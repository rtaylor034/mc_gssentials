#> gssen:_/impl/array/set/difference/iter
#--------------------
...
execute store result score *difference.match gssen_var run function gssen:_/impl/array/set/difference/compare with storage gssen:out partial
