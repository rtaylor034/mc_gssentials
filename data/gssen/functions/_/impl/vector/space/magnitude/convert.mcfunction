#>gssen:_/impl/vector/magnitude/convert
#--------------------
...
execute summon item_display run function gssen:_/impl/vector/space/magnitude/transform with storage gssen:var magnitude.vec